...
matcher==="jpg"||matcher==="jpeg"||matcher==="gif"){viewButton[i-1]=butEl.cloneNode(true);viewButton[i-1].setAttribute("data-url",el.getAttribute("href"));el.insertAdjacentHTML("afterend",viewButton[i-1].outerHTML)}if(i==len-1)$(document).trigger("finishedObserved")})}})(jQuery);